...
PopObjectValue("_eq_n__lit_0", "_eq_n__lit_0", "or")
Call("_eq_n__lit_0#or", vec!["_eq_n__lit_1"], "_eq_n__lit_0")
Alloc("_if_0_expr")
PushCallResult("_if_0_expr")
Branch("if_0_expr", "terminate", "recurse")
...
Alloc("_lit_3")
PushInt("_lit_3", 2)
PushCallResult("_n#sub")
PopObjectValue("_n#sub", "n", "sub")
Call("_n#sub", vec!["_lit_2"], "n")
Alloc("_sub_n__lit_2")
PushCallResult("_sub_n__lit_2")
Call("n#sub", vec!["_lit_3"], "n")
Alloc("_sub_n__lit_3")
PushCallResult("_sub_n__lit_3")
Call("fibonacci", vec!["_sub_n__lit_2"], None)
Alloc("_fibonacci__sub_n__lit_2")
PushCallResult("_fibonacci__sub_n__lit_2")
Call("fibonacci", vec!["_sub_n__lit_3"], None)
Alloc("_fibonacci__sub_n__lit_3")
PushCallResult("_fibonacci__sub_n__lit_3")
Alloc("_fibonacci__sub_n__lit_2#add")
PopObjectValue("_fibonacci__sub_n__lit_2#add", "_fibonacci__sub_n__lit_2", "add")
Call("_fibonacci__sub_n__lit_2#add", vec!["_fibonacci__sub_n__lit_3"], "_fibonacci__sub_n__lit_2")
Alloc("_add__fibonacci__sub_n__lit_2__fibonacci__sub_n__lit_3")
PushCallResult("_add__fibonacci__sub_n__lit_2__fibonacci__sub_n__lit_3")
Return("_add__fibonacci__sub_n__lit_2__fibonacci__sub_n__lit_3")
```
...
PopObjectValue("_i#add", "i", "add")
Call("_i#add", vec!["_lit_0"], "i")
Alloc("_sum#add")
PopObjectValue("_sum#add", "sum", "add")
Call("sum#add", vec!["a"], "sum")
PushCallResult("sum")
GoTo("_while_0_loop")
