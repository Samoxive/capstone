...
Alloc("_lit_3")
PushInt("_lit_3", 2)
PushCallResult("n#sub")
PopObjectValue("n#sub", "n", "sub")
Call("n#sub", vec!["_lit_2"], "n")
Alloc("_sub_n__lit_2")
PushCallResult("")
...
Alloc("_sum__fibonacci__sub_n__lit_2__fibonacci__sub_n__lit_3")
PushCallResult("_sum__fibonacci__sub_n__lit_2__fibonacci__sub_n__lit_3")
Return("_sum__fibonacci__sub_n__lit_2__fibonacci__sub_n__lit_3")
```
